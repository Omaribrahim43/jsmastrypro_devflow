            ...
            {userId ? (
              <SheetClose asChild>
                ...
                >
                  <Button
                    type="submit"
                    className="base-medium w-fit !bg-transparent px-4 py-6"
                  >
              ...
              <>
                ...
                <SheetClose asChild>
                  <Link href={ROUTES.SIGN_UP}>
                    <Button className="small-medium light-border-2 min-h-[41px] btn-tertiary text-dark400_light900 w-full rounded-lg  border px-4 py-6 shadow-none">
                      Sign Up
                    </Button>
                  </Link>
                </SheetClose>
